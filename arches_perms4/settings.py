"""
Django settings for arches_perms4 project.
"""
...
DATATYPE_LOCATIONS.append("arches_perms4.datatypes")
FUNCTION_LOCATIONS.append("arches_perms4.functions")
ETL_MODULE_LOCATIONS.append("arches_perms4.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_perms4.search_components")
...
SECRET_KEY = "django-insecure-uclt6x*pv-=93#5vgh!*rk2vaiz7f$mfb#(!hizvo8u#4i1go9"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_perms4.urls"
ROOT_HOSTCONF = "arches_perms4.hosts"

DEFAULT_HOST = "arches_perms4"
...
ELASTICSEARCH_PREFIX = "arches_perms4"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_perms4.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_perms4",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_perms4.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_perms4"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_perms4.search.es_mapping_modifier.EsMappingModifier"]
